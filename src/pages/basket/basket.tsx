...
function Basket(): JSX.Element {
  ...
  useLockScroll<boolean, null>(loading);
              ...
              <ul className="basket__list">
                <li className="basket-item">
                  <div className="basket-item__img">
                    <picture>
                      <source type="image/webp" srcSet="img/content/img9.webp, img/content/img9@2x.webp 2x"></source>
                      <img src="img/content/img9.jpg" srcSet="img/content/img9@2x.jpg 2x" width="140" height="120" alt="Фотоаппарат «Орлёнок»"></img>
                    </picture>
                  </div>
                  ...
                  <div className="quantity">
                    ...
                    <input type="number" id="counter1" value="2" min="1" max="99" aria-label="количество товара"></input>
                ...
                <li className="basket-item">
                  <div className="basket-item__img">
                    <picture>
                      <source type="image/webp" srcSet="img/content/img1.webp, img/content/img1@2x.webp 2x"></source>
                      <img src="img/content/img1.jpg" srcSet="img/content/img1@2x.jpg 2x" width="140" height="120" alt="Ретрокамера «Das Auge IV»"></img>
                    </picture>
                  </div>
                  <div className="basket-item__description">
                  ...
                  <div className="quantity">
                    ...
                    <input type="number" id="counter2" value="1" min="1" max="99" aria-label="количество товара"></input>
                    <button className="btn-icon btn-icon--next" aria-label="увеличить количество товара">
                      <svg width="7" height="12" aria-hidden="true">
                        <use xlinkHref="#icon-arrow"></use>
                      </svg>
